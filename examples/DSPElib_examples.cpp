...
/* ************************************************************* */
/*! Laboratorium: Wieloszybkościowe przetwarzanie sygnałów w systemach wielokanałowych
 *  Ćw. 5. zad. 2.
 *
 * \author Marek Blok
 * \date 2012.04.30
...
// output real samples
  ...
  // można też czytać bezpośrednio do OutputSamples
}
...
{
  /*! Koncepcja
  * - cztery kanały - różne modulacje - ten sam filtr kształtujący
  *   DPSK, pi/4-QPSK, (MSK), OQPSK, QAM-16, OOK
  * - FFT - 32 ==> od razu lokowanie na PCz (nadporóbkowanie 32)
  * - dostępne kanały 1..15 (nie można użyć dla FMT dwóch sąsiednich
  *   użycie: 8, 10, 13
  * reszta stałe zero !!! SetConstInput (chyba powinno działać)
  */
  /*************************************************************/
  // Log file setup
  DSP::f::SetLogFileName("log_file.log");
